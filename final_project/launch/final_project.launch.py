...
from launch.actions import (
    ...
    OpaqueFunction,
    TimerAction,  # Import TimerAction
)
...
def launch_setup(context, *args, **kwargs):
    ...
    # Add a TimerAction to delay the start of the second static transform
    static_transform_cmd2_timer = TimerAction(
    ...
    nodes_to_start = [
        ...
        static_transform_cmd2_timer,  # Add the TimerAction here
    ]
